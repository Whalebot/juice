...
public class CameraController : MonoBehaviour
{
	...
	[Header("ScrenShake")]
	[SerializeField] public float shakeTimeStandardStrong = 0.5f;
	[SerializeField] public float strengthStandardStrong = 0.5f;
	[SerializeField] public float shakeTimeStandardLight = 0.2f;
	[SerializeField] public float strengthStandardLight = 0.2f;
